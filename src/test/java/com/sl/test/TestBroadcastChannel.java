...
import static com.sl.pages.PageManager.Form.AUDIOPIDs;
...
public class TestBroadcastChannel extends ConfigBase {
	...
	public void createAudioPIDinBCwithFillForm(){
		...
		.setNumber(rndNum)
		.addAudioPID();
		List<Element> randomAP = app.getDataHelper().getRandomValues(AUDIOPIDs);
		app.getFormHelper().fillForm(randomAP, AUDIOPIDs);
		pageManager.audioPIDs.create();
		...
		app.getFormHelper().verifyForm(randomAP, AUDIOPIDs);
